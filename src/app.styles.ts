...
export const styles = stylex.create({
	...
	fieldLegend: { fontWeight: 700, marginBottom: '0.4rem', padding: 0 },
	playerCountOptions: {
		display: 'grid',
		gap: '0.5rem',
	...
	play: {
		...
		gridTemplateRows: { default: 'auto auto auto', [mobile]: 'none' },
		padding: '12px',
	},
	turnStrip: {
		alignItems: 'center',
	...
	coins: {
		alignContent: 'start',
		gridColumn: { default: '1', [mobile]: 'auto' },
