...
export const createSession = (players: Array<Pick<Player, "name" | "color" | "symbol">>): Session => ({
  version: 1,
  setupComplete: false,
  ...
  completedTurns: 0,
  missions: [],
  scratchpad: { coins: 0, combat: 0, missionPoints: 0, acknowledged: [], lastPayment: null },
...
export const paymentFor = (coins: number, boxings: number, cost: number) => {
  ...
  return { paidTurnCoins, paidBoxings, remainingUnpaid: remaining - paidBoxings }
}
